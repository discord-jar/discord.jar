...
public class AutomodRuleCreateAction {
    ...
    public AutomodRuleCreateAction(String name, AutomodRule.EventType eventType, AutomodRule.TriggerType triggerType, List<AutomodRule.Action> actions, Guild guild, DiscordJar discordJar) {
        this.name = name;
        this.eventType = eventType;
        this.triggerType = triggerType;
        this.actions = actions;
    ...
    public AutomodRuleCreateAction(String name, AutomodRule.EventType eventType, AutomodRule.TriggerType triggerType, AutomodRule.TriggerMetadata metadata, List<AutomodRule.Action> actions, Guild guild, DiscordJar discordJar) {
        this.name = name;
        this.eventType = eventType;
        this.triggerType = triggerType;
        this.actions = actions;
