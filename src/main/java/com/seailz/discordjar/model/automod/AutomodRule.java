package com.seailz.discordjar.model.automod;
...
public record AutomodRule(
    ...
    public static AutomodRule decompile(@NotNull JSONObject obj, @NotNull DiscordJar discordJar) throws DiscordRequest.UnhandledDiscordAPIErrorException {
        ...
        id = obj.getString("id");
        guild = discordJar.getGuildById(obj.getString("guild_id"));
        name = obj.getString("name");
        creator = discordJar.getUserById(obj.getString("creator_id"));
