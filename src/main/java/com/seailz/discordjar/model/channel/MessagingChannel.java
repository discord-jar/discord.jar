...
public interface MessagingChannel extends GuildChannel, CategoryMember, Typeable, Messageable, MessageRetrievable, Transcriptable {
    ...
    static MessagingChannel decompile(SJSONObject obj, DiscordJar discordJar) {
        ...
        String topic = !obj.has("topic") || obj.get("topic") == null || obj.get("topic").equals(SJSONObject.NULL) ? null : obj.getString("topic");
        String lastMessageId = !obj.has("last_message_id") || obj.get("last_message_id") == null || obj.get("last_message_id").equals(SJSONObject.NULL) ? null : obj.getString("last_message_id");
        int defaultAutoArchiveDuration = obj.has("default_auto_archive_duration") ? obj.getInt("default_auto_archive_duration") : 0;
        return new MessagingChannelImpl(id, type, name, guild, position, permissionOverwrites, nsfw, obj.has("parent_id") && !obj.isNull("parent_id") ? obj.getString("parent_id") : null ,slowMode, topic, lastMessageId, defaultAutoArchiveDuration, discordJar, obj);
    }
