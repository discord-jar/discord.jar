 ...
 * @see    GuildChannel
 */
public interface MessagingChannel extends GuildChannel, CategoryMember, Typeable {
    ...
    static MessagingChannel decompile(JSONObject obj, DiscordJar discordJar) {
        ...
        return new MessagingChannelImpl(id, type, name, guild, position, permissionOverwrites, nsfw, obj.has("parent_id") ? Category.fromId(obj.getString("parent_id"), discordJar) : null ,slowMode, topic, lastMessageId, defaultAutoArchiveDuration, discordJar, obj);
    }
