...
public class AudioChannelImpl extends GuildChannelImpl implements AudioChannel {
    ...
    public AudioChannelImpl(String id, ChannelType type, String name, Guild guild, int position, List<PermissionOverwrite> permissionOverwrites, boolean nsfw, String lastMessageId, VoiceRegion region, Category category, int bitrate, SJSONObject raw, DiscordJar discordJar) {
