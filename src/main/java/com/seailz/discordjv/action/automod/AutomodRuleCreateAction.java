...
public class AutomodRuleCreateAction {
    ...
    public AutomodRuleCreateAction(String name, AutomodRule.EventType eventType, AutomodRule.TriggerType triggerType, AutomodRule.TriggerMetadata triggerMetadata, List<AutomodRule.Action> actions, boolean enabled, List<Role> exemptRoles, List<Channel> exemptChannels, Guild guild, DiscordJv discordJv) {
        this.name = name;
    ...
    public AutomodRuleCreateAction(String name, AutomodRule.EventType eventType, AutomodRule.TriggerType triggerType, List<AutomodRule.Action> actions, Guild guild, DiscordJv discordJv) {
        this.name = name;
        this.eventType = eventType;
        this.triggerType = triggerType;
        this.actions = actions;
    ...
    public AutomodRuleCreateAction(String name, AutomodRule.EventType eventType, AutomodRule.TriggerType triggerType, AutomodRule.TriggerMetadata metadata, List<AutomodRule.Action> actions, Guild guild, DiscordJv discordJv) {
        this.name = name;
        this.eventType = eventType;
        this.triggerType = triggerType;
        this.actions = actions;
    ...
    public AutomodRuleCreateAction setEventType(AutomodRule.EventType eventType) {
        this.eventType = eventType;
        return this;
    }

    public AutomodRuleCreateAction setTriggerType(AutomodRule.TriggerType triggerType) {
        this.triggerType = triggerType;
        return this;
    }

    public AutomodRuleCreateAction setTriggerMetadata(AutomodRule.TriggerMetadata triggerMetadata) {
        this.triggerMetadata = triggerMetadata;
        return this;
    }

    public AutomodRuleCreateAction setActions(List<AutomodRule.Action> actions) {
        this.actions = actions;
        return this;
    }
    ...
    public AutomodRuleCreateAction setExemptRoles(List<Role> exemptRoles) {
        this.exemptRoles = exemptRoles;
        return this;
    }

    public AutomodRuleCreateAction setExemptChannels(List<Channel> exemptChannels) {
        this.exemptChannels = exemptChannels;
        return this;
    }

    public AutomodRuleCreateAction addExemptChannel(Channel channel) {
        this.exemptChannels.add(channel);
        return this;
    }

    public AutomodRuleCreateAction addExemptRole(Role role) {
    ...
    public CompletableFuture<AutomodRule> run() {
        ...
        future.completeAsync(() -> {
            ...
            DiscordRequest request = new DiscordRequest(
                    payload,
                    new HashMap<>(),
                    URLS.POST.GUILDS.AUTOMOD.CREATE_AUTO_MOD_RULE.replace(
                            "{guild.id}",
                            guild.id()
                    ),
                    discordJv,
                    URLS.POST.GUILDS.AUTOMOD.CREATE_AUTO_MOD_RULE,
                    RequestMethod.POST
            );
