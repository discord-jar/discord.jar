...
public interface MessagingChannel extends GuildChannel, CategoryMember {
    ...
    static MessagingChannel decompile(JSONObject obj, DiscordJv discordJv) {
        ...
        String lastMessageId = obj.has("last_message_id") || obj.get("last_message_id") == null || obj.get("last_message_id").equals(JSONObject.NULL) ? obj.getString("last_message_id") : null;
