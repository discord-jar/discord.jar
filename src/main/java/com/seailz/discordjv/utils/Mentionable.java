 ...
 * <br>At the moment, the only mentionable entities are {@link com.seailz.discordjv.model.user.User users}, {@link com.seailz.discordjv.model.channel.Channel channels}, and {@link com.seailz.discordjv.model.role.Role roles}.
 * <p>
 * Note: If this has changed when you are reading this, please open an issue or pull request <a href="https://www.github.com/discord-jv/discord.jv">here</a>. Thanks :)
 *
 * @author Seailz
 * @see com.seailz.discordjv.model.role.Role
 * @see com.seailz.discordjv.model.user.User
 * @see com.seailz.discordjv.model.channel.Channel
 * @since 1.0
 */
