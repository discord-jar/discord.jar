 ...
 * This component is only available in {@link com.seailz.javadiscordwrapper.model.interaction.modal.Modal Modals}
 *
 * @author Seailz
 * @since  1.0
...
public class TextInput implements ModalComponent {
     ...
     *
     * @param customId
     *        The custom id of the component (max 100 characters)
     *
     * @param style
     *        The {@link TextInputStyle} of the component
     *
     * @param label
     ...
     *
     * @param value
     *        The pre-filled value of the component
     *
     * @param minLength
     *        The minimum length of the input (min 0, max 4000), default 0
     *
     * @param maxLength
     *        The maximum length of the input (min 1, max 4000), default 4000
     */
